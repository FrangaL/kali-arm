...
# This is Kali Linux ARM image for Mini-X
...
base="apt-transport-https apt-utils e2fsprogs ifupdown initramfs-tools parted usbutils firmware-linux firmware-atheros firmware-libertas firmware-realtek u-boot-menu u-boot-sunxi kali-defaults kali-menu linux-image-armmp sudo"
# GUI
