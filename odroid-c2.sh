...
extras="alsa-utils bc bison bluez bluez-firmware fbset libnss-systemd libssl-dev triggerhappy"
...
#!/bin/bash
update-initramfs -c -k 3.16.72
mkimage -A arm64 -O linux -T ramdisk -C none -a 0 -e 0 -n "uInitrd" -d /boot/initrd.img-3.16.72 /boot/uInitrd
rm -f /create-initrd
EOF
