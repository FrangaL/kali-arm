...
# This is Kali Linux ARM image for HP ARM Chromebook (daisy_spring)
# More information: https://www.kali.org/docs/arm/chromebook/
...
base="apt-transport-https apt-utils bash-completion console-setup dialog e2fsprogs ifupdown initramfs-tools inxi iw man-db mlocate netcat-traditional net-tools parted psmisc rfkill screen tmux unrar usbutils vim wget whiptail zerofree firmware-samsung"
# GUI
desktop="kali-desktop-xfce kali-root-login xserver-xorg-video-fbdev xfonts-terminus xinput xserver-xorg-input-libinput xserver-xorg-input-synaptics"
# Kali Tools
