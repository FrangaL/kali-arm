...
# This is Kali Linux ARM image for NanoPC-T3
...
imagename=${3:-kali-linux-$1-nanopc-t3}
...
# Any extra packages
extras="alsa-utils bc bison bluez bluez-firmware kali-linux-core libnss-systemd libssl-dev triggerhappy i2c-tools python3-smbus"
...
#git clone --depth 1 https://github.com/friendlyarm/u-boot -b nanopi2-v2016.01
#cd u-boot
