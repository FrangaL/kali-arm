...
# This is Kali Linux ARM image for Raspberry Pi 2 v1.2/3/4/400 (64-bit)
# More information:
...
imagename=${3:-kali-linux-$1-rpi-64bit}
...
current_dir="$(pwd)"
# Base directory
basedir=${current_dir}/rpi-64bit-"$1"
# Working directory
...
# Any extra packages
extras="alsa-utils bc bison bluez bluez-firmware i2c-tools kali-linux-core libnss-systemd libssl-dev python3-configobj python3-pip python3-requests python3-rpi.gpio python3-smbus triggerhappy pkg-config"
...
eatmydata apt-get -y install binutils ca-certificates console-common git less locales nano initramfs-tools u-boot-tools cmake
