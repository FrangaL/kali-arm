...
# This is Kali Linux ARM image for Pinebook
...
base="apt-transport-https apt-utils bash-completion console-setup dialog e2fsprogs ifupdown initramfs-tools inxi iw man-db mlocate netcat-traditional net-tools parted pciutils psmisc rfkill screen tmux unrar usbutils vim wget whiptail zerofree u-boot-menu u-boot-sunxi dkms linux-image-arm64 linux-headers-arm64 arm-trusted-firmware"
# GUI
...
git clone --depth 1 https://github.com/anarsoul/rtl8723bt-firmware
...
# inside the chroot
cd /usr/src/
git clone --depth 1 https://github.com/icenowy/rtl8723cs rtl8723cs-2020.02.27
