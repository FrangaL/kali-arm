...
int uname(struct utsname *buf)
{
 ...
 strcpy(buf->release, "5.5.0-kali2-armmp");
...
LD_PRELOAD=/root/libfakeuname.so apt-get --yes --allow-change-held-packages install linux-image-armmp u-boot-imx
...
echo "T1:23:respawn:/sbin/agetty -L ttymxc1 115200 vt100" >> "${basedir}"/kali-${architecture}/etc/inittab
