...
# This is Kali Linux ARM image for ASUS Chromebook Flip (Veyron)
...
# Any extra packages
extras="alsa-utils bc bison bluez bluez-firmware kali-linux-core libnss-systemd libssl-dev triggerhappy florence"
...
eatmydata apt-get -y install binutils ca-certificates console-common git less locales nano u-boot-tools git-core cryptsetup-bin initramfs-tools
