...
parted -s ${current_dir}/${imagename}.img --script -- mklabel msdos
parted -s ${current_dir}/${imagename}.img --script -- mkpart primary fat32 1MiB ${bootsize}MiB
parted -s -a minimal ${current_dir}/${imagename}.img --script -- mkpart primary $fstype ${bootsize}MiB 100%
