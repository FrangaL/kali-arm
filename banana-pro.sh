...
# This is Kali Linux ARM image for Banana Pro
...
imagename=${3:-kali-linux-$1-banana-pro}
...
current_dir="$(pwd)"
# Base directory
basedir=${current_dir}/banana-pro-"$1"
# Working directory
...
base="apt-transport-https apt-utils bash-completion console-setup dialog e2fsprogs ifupdown initramfs-tools inxi iw man-db mlocate netcat-traditional net-tools parted pciutils psmisc rfkill screen tmux unrar usbutils vim wget whiptail zerofree u-boot-menu u-boot-sunxi dkms linux-image-armmp"
# GUI
