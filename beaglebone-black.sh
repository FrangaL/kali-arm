...
# This is Kali Linux ARM image for BeagleBone Black
...
current_dir="$(pwd)"
# Base directory
basedir=${current_dir}/beaglebone-black-"$1"
# Working directory
...
git clone --depth 1 https://github.com/beagleboard/linux -b 4.9 ${work_dir}/usr/src/kernel
